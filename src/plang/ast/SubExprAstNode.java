...
/**
 * Represents a subtract {@code <expr>} AST node.
 */
public final class SubExprAstNode extends ExprAstNode {
    /**
    ...
    /**
     * Initializes a new {@link SubExprAstNode}.
     *
     * @param expr1 The first {@code <expr>} child node.
     * @param expr2 The second {@code <expr>} child node.
     */
    public SubExprAstNode(ExprAstNode expr1, ExprAstNode expr2) {
        super(expr1, expr2);
    }
