...
/**
 * Represents a less than or equal {@code <boolexpr>} AST node.
 */
public final class LeBoolExprAstNode extends BoolExprAstNode {
    /**
    ...
    /**
     * Initializes a new {@link LeBoolExprAstNode}.
     *
     * @param expr1 The first {@code <expr>} child node.
     * @param expr2 The second {@code <expr>} child node.
     */
    public LeBoolExprAstNode(ExprAstNode expr1, ExprAstNode expr2) {
        super(expr1, expr2);
    }
